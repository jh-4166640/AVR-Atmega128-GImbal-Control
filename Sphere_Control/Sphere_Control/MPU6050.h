...
// These are the names for the bits.
// Use these only with the bit() macro.
#define MPU6050_CTRL_SIG_COND_RESET MPU6050_D0
#define MPU6050_CTRL_I2C_MST_RESET  MPU6050_D1
#define MPU6050_CTRL_FIFO_RESET     MPU6050_D2
#define MPU6050_CTRL_I2C_IF_DIS     MPU6050_D4   // must be 0 for MPU-6050
#define MPU6050_CTRL_I2C_MST_EN     MPU6050_D5
#define MPU6050_CTRL_FIFO_EN        MPU6050_D6
...
#define SamplingFreq	100.0f
#define KpDef			(2.0f * 1.0f)
#define KiDef			(2.0f * 0.05f)
#define GYRO_SENSITIVITY	131.0f // 자이로 감도
#define ACCEL_SENSITIVITY	8192.0f
#define DT_SEC				0.01f // 샘플링 주기 100Hz임
...
extern volatile Quarternion_t Qtn;
